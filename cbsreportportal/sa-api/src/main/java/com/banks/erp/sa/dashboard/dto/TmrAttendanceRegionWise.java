...
public class TmrAttendanceRegionWise implements Serializable {
	...
	public TmrAttendanceRegionWise() {
	}

	public TmrAttendanceRegionWise(String groupName, Integer tmrTotal, Integer tmrPresence) {
