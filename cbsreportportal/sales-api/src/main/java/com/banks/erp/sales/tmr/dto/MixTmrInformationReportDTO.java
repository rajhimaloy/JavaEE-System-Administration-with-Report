 ...
 *
 */
public class MixTmrInformationReportDTO implements Serializable {
	...
	private String tmoWalet;
	private String dsoWalet;	
	private String uddoktaWalet;	
	private Integer totalMarketHour;
	...
	public MixTmrInformationReportDTO() {
	}
	...
	public String getTmoWalet() {
		return tmoWalet;
	}

	public void setTmoWalet(String tmoWalet) {
		this.tmoWalet = tmoWalet;
	}
	...
	public Integer getTotalMarketHour() {
		return totalMarketHour;
	}

	public void setTotalMarketHour(Integer totalMarketHour) {
		this.totalMarketHour = totalMarketHour;
	}
